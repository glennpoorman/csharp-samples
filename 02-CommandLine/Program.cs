...
//
// This sample takes command line arguments and echoes them back to console output. In a simple C#
// application consisting of top level statements, the command line arguments are simply available as
// an array of strings named "args".
//
// Note that to see the program work, command line arguments need to be specified either by running the
// program from a DOS prompt or by adding the arguments to the project properties in Visual Studio.
// ------------------------------------------------------------------------------------------------------

// Write the number of command line arguments to the console. Please note the following:
//
// 1. All arrays in C# have a "Length" property that returns the current length of the array (more on
...
//
// 2. The numeric value of the "Length" property is written to the output string similar to the way a
