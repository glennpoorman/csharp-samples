...
//
// This sample takes command line arguments and echoes them back to console output. 
//
...
//
// 1. In a simple C# application consisting of top level statements, the command line arguments are
//    simply available as an array of strings named "args".
//
// 2. All arrays in C# have a "Length" property that returns the current length of the array (more on
//    arrays later). Note that "Length" is a "property" as opposed to a data member or method (more on
//    properties later as well).
//
